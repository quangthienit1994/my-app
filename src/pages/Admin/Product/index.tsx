            ...
            <div className="libraries">
                <Paper className="mb-1 rounded-0">
                    <Tabs
                        ...
                        textColor="secondary"
                    >
                        <Tab component="div" label="TẤT CẢ SẢN PHẨM" icon={<Bookmark />} />
                        <Tab component="div" label="THÊM SẢN PHẨM" icon={<CreateIcon />} />
                        <Tab component="div" label="DANH MỤC" icon={<Label />} />
                        <Tab component="div" label="THẺ MÂY" icon={<Cloud />} />
                    </Tabs>
                </Paper>

                {this.state.activeTab === 0 && <Posts onChange={this.handleChangePost} type="post" name="san-pham" />}
                {this.state.activeTab === 1 && <Create post={this.state.post} type="post" name="san-pham" />}
                {this.state.activeTab === 2 && <Category type="category" term="danh-muc-san-pham" />}
                {this.state.activeTab === 3 && <Category type="tag" term="the-may-san-pham" />}
            </div>
        );
    }
